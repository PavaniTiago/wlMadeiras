        ...
        <footer className="flex flex-col items-center w-full gap-12 pb-8 pt-32 bg-[#222C55]">
            <div className="flex w-full justify-evenly items-center flex-wrap">
                <div className="flex flex-col items-start justify-center">
                    <h2>logo</h2>
                    <p className="text-xs md:text-base text-primary-foreground max-w-24 md:max-w-sm">
                ...
                <div className="flex flex-col items-start justify-center gap-3">
                    <h3 className="font-semibold text-sm md:text-xl text-white">Links</h3>
                    <Link href="/#sobre-nos" className="text-primary-foreground text-xs md:text-base hover:text-lol transition-all">Quem somos</Link>
                    <Link href="#" className="text-primary-foreground text-xs md:text-base hover:text-lol transition-all">Obras</Link>
                    <Link href="/contato" className="text-primary-foreground text-xs md:text-base hover:text-lol transition-all">Contato</Link>
                </div>
            </div>
