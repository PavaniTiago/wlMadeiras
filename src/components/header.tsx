...
export const Header = () => {
    return (
        <header className="flex w-full bg-[#FFF117] justify-between px-4 md:px-32 h-24 items-center absolute top-0 z-10">
            <Image alt="logo icon" src='/logo.png' width={0} height={0} sizes="100vw" className="object-cover w-[10rem] md:w-[18rem]"/>
            <ul className="hidden md:flex absolute -inset-x-0 items-center justify-center gap-8 text-sm uppercase font-semibold text-[#222C55] [&>li:hover]:text-neutral-900 transition-all">
            ...
            <Sheet>
                <SheetTrigger asChild>
                    <button className="md:hidden text-[#222C55]">
