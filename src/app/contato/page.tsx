    ...
    <main className="flex min-h-screen flex-col items-center bg-neutral-100 overflow-x-hidden relative">
      ...
      <section className="h-screen absolute w-full flex items-center justify-center gap-6">
        <div className="flex flex-col">
          <h2 className="text-4xl font-bold text-neutral-50 mb-2">Contact Us</h2>
          <p className="text-md text-neutral-200 mb-6">Fill out the form below to get in touch with us.</p>
        </div>
      <form className="space-y-4 w-[22rem]">
        <div className="flex flex-col">
        ...
        <button type="submit" className="inline-flex items-center px-12 py-2 border border-transparent shadow-sm text-sm font-medium text-white rounded-md bg-[#222C55] hover:bg-[#303e74] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Enviar
        </button>
      </form>
      </section> 
