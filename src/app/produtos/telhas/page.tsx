      ...
      <div className="flex w-full items-center justify-center relative">
        ...
        <section className="h-screen absolute w-full flex items-center justify-center gap-6 px-4 md:px-0">
          <div className="flex flex-col text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-50 mb-2">Telhas</h2>
            <p className="text-sm md:text-md text-neutral-200 mb-6 max-w-md">Visualize nossos Telhas com material de primeira. Para mais dúvidas clique no botão Entrar em Contato</p>
          </div>
        </section> 
      </div>
      <section className="flex flex-col md:flex-row my-auto justify-between items-center gap-10 px-4 md:px-0">
        <div className="flex flex-col text-center md:text-left">
          <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-2">Telhas</h2>
          <p className="text-sm md:text-md text-neutral-700 mb-6 max-w-md">Visualize nossos Telhas com material de primeira. Para mais dúvidas clique no botão Entrar em Contato</p>
